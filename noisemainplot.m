...
% plots the selected data in the axes.
    ...
    align([hchan1,hsen1,hchan2,hsen2,hchan3,hsen3,hpopupsen1, ...
        ...
        starttime, endtime, hstime, hetime],'Center','None');
   ...
   set([f,ha,hchan1,hsen1,hchan2,hsen2,hchan3,hsen3,hpopupsen1, ...
       hpopupsen2, hpopupsen3, hpopupdig1, hpopupdig2, hpopupdig3, ...
       hdig1, hdig2, hdig3, plotme, clearme, saveme, ...
       starttime, endtime, hstime, hetime],...
   'Units','normalized');
   ...
   % Make the GUI visible.
    ...
    function plot_Callback(~,~)
        ...
        stahand3=[];
        if(~isempty(datafile1))
            [pspec1, per1, stahand1, tseries1,ttime1] = noise(datafile1, ...
        sen1,dig1,stimestr,etimestr);
        ...
        sen2,dig2,stimestr,etimestr);
            ...
            xlabel('Time (HH:MM)','FontSize',14);
            ylabel('Volts');
            title(['Channel 2 Time Series ' thand2],'FontSize',14);
            set(gca,'fontsize',14);    
        end   
        if(~isempty(datafile3))
